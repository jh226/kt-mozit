...
const ITEMS = [
  {
    ...
    label: 'Website',
    children: [
      { id: '1.1', label: 'Home', color: 'green', link : '/' },
      { id: '1.2', label: 'Pricing', color: 'green' },
      { id: '1.3', label: 'About us', color: 'green', link: '/aboutus' },
      {
        id: '1.4',
        label: 'Blog',
        children: [
...
function CustomLabel({ color, expandable, children, link, ...other }) {
...
CustomLabel.propTypes = {
  ...
  link: PropTypes.string, // 링크를 받을 수 있도록 수정
};
    ...
    <TreeItem2Provider itemId={itemId}>
      <TreeItem2Root {...getRootProps(other)}>
        ...
        >
          ...
          <CustomLabel {...getLabelProps({ color })} link={link} />
        </TreeItem2Content>
        {children && (
          <TransitionComponent
